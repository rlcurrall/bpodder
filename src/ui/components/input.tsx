...
type InputProps = Omit<InputHTMLAttributes, "type" | "class"> & {
  class?: string;
  type?: "email" | "number" | "password" | "search" | "tel" | "text" | "url" | DateType;
  ref?: preact.Ref<HTMLInputElement>;
};

export function Input({ class: className, type = "text", ref, ...props }: InputProps) {
  const isDateType = dateTypes.includes(type as DateType);
